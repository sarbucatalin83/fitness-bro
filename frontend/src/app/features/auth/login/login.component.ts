  ...
  template: `
    <div class="min-h-screen bg-zinc-950 flex flex-col justify-center px-6 py-12">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-zinc-400 mt-2">Sign in to continue your fitness journey</p>
      </div>
      ...
      <div class="bg-zinc-900 rounded-2xl p-6">
        ...
        <div class="mt-6 text-center">
          <p class="text-zinc-400">
            ...
            <a routerLink="/signup" class="text-orange-500 hover:text-orange-400 font-medium ml-1">
              Sign Up
            </a>
          </p>
        </div>
      ...
      @if (showForgotPassword()) {
        <div class="fixed inset-0 bg-black/80 flex items-center justify-center p-6 z-50">
          <div class="bg-zinc-900 rounded-2xl p-6 w-full max-w-sm">
            <h2 class="text-xl font-bold text-white mb-2">Reset Password</h2>
            <p class="text-zinc-400 text-sm mb-4">Enter your email and we'll send you a reset link.</p>

            @if (resetEmailSent()) {
              <div class="bg-green-500/10 border border-green-500/20 rounded-xl p-4 mb-4">
                <p class="text-green-400 text-sm">Check your email for the reset link!</p>
              </div>
            }
            ...
            <input
              type="email"
              [(ngModel)]="resetEmail"
              class="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-4 py-3 text-white placeholder-zinc-500 focus:outline-none focus:border-orange-500 transition-colors mb-4"
              placeholder="Enter your email"
            />
            ...
            <div class="flex gap-3">
              ...
              <button
                ...
                [disabled]="authService.isSubmitting()"
                class="flex-1 bg-orange-500 text-white font-medium py-3 rounded-xl hover:bg-orange-600 transition-colors disabled:opacity-50"
              >
                Send Link
              </button>
            </div>
